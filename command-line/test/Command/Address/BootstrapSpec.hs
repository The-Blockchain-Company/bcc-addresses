...
specCole :: [String] -> String -> String -> String -> SpecWith ()
specCole phrase path networkTag want = it ("golden cole " <> path <> " (" <> networkTag <> ")") $ do
    rootPrv <- cli [ "key", "from-recovery-phrase", "cole" ] (unwords phrase)
