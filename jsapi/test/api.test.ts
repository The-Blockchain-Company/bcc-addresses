...
import * as library from '../src/bcc-addresses';
...
describe('inspectAddress', () => {
  describe('Happy path', () => {
    it('Cole testnet encrypted', async () => {
    ...
    it('Cole mainnet decrypted', async () => {
  ...
  describe('Malformed address', () => {
    ...
    it('Worng Cole', () => {
      ...
      return expect(inspectAddress(addr)).rejects.toEqual({
        ...
        message: "Invalid Sophie address: Unknown address type 0"
      });
    });
    it('Worng Icarus', () => {
      ...
      return expect(inspectAddress(addr)).rejects.toEqual({
        ...
        message: "Invalid Sophie address: Unknown address type 192"
      });
    });
    ...
    it('Non-matching xpub for Cole', () => {
      ...
      return expect(inspectAddress(addr, xpub)).rejects.toEqual({
        ...
        message: "Invalid Cole address: Failed to decrypt derivation path"
      });
    });
  });
  describe('Other', () => {
    ...
    it('Sophie network tag 3', () => expect(inspectAddress("addr1qdu5vlrf4xkxv2qpwngf6cjhtw542ayty80v8dyr49rf5ewvxwdrt70qlcpeeagscasafhffqsxy36t90ldv06wqrk2q5ggg4z")).resolves.toEqual({
      "address_style": "Sophie",
      "network_tag": 3,
      "spending_key_hash": "79467c69a9ac66280174d09d62575ba955748b21dec3b483a9469a65",
      "spending_key_hash_bech32": "addr_vkh109r8c6df43nzsqt56zwky46m492hfzepmmpmfqafg6dx28nj4yj",
    ...
    it('Sophie Payment Mainnet', () => expect(inspectAddress("addr1vx3qz578hx8vhjteujmpm8lczzh8hxghnq9y6t4t2x420dg05vms2")).resolves.toEqual({
      "stake_reference": "none",
    ...
    it('Sophie Pointer network tag 3', () => expect(inspectAddress("addr1gw2fxv2umyhttkxyxp8x0dlpdt3k6cwng5pxj3jhsydzer5ph3wczvf2x4v58t")).resolves.toEqual({
      "address_style": "Sophie",
      "network_tag": 3,
      "pointer": {
        "output_index": 42,
    ...
    it('Sophie Stake network tag 0', () => expect(inspectAddress("stake1upshvetj09hxjcm9v9jxgunjv4ehxmr0d3hkcmmvdakx7mqcjv83c")).resolves.toEqual({
      "address_style": "Sophie",
      "network_tag": 0,
    ...
    it('Sophie Stake Shared network tag 0', () => expect(inspectAddress("stake17pshvetj09hxjcm9v9jxgunjv4ehxmr0d3hkcmmvdakx7mq36s8xc")).resolves.toEqual({
      "address_style": "Sophie",
      "network_tag": 0,
    ...
    it('Sophie network tag 0', () => expect(inspectAddress("addr_test1qpwr8l57ceql23ylyprl6qgct239lxph8clwxy5w8r4qdz8ct9uut5ahmxqkgwy9ecn5carsv39frsgsq09u70wmqwhqjqcjqs")).resolves.toEqual({
      "address_style": "Sophie",
      "network_tag": 0,
    ...
    it('Sophie Stake network tag 0', () => expect(inspectAddress("stake_test1uru9j7w96wmanqty8zzuuf6vw3cxgj53cygq8j708hds8tsntl0j7")).resolves.toEqual({
      "address_style": "Sophie",
      "network_tag": 0,
      "stake_key_hash": "f85979c5d3b7d981643885ce274c7470644a91c11003cbcf3ddb03ae",
      "stake_key_hash_bech32": "stake_vkh1lpvhn3wnklvczepcsh8zwnr5wpjy4ywpzqpuhneamvp6uwkgwm8",
    ...
    it('Sophie Mainnet', () => expect(inspectAddress("addr1q9777p2w2hqa3cl0ah97pdwyavjnpf0ex3muvqgttavjxhku2rp98h9drzkdfva8ea775jszmd799k59aknpvqyn6wwqwll7uw")).resolves.toEqual({
      "address_style": "Sophie",
      "network_tag": 1,
    ...
    it('Sophie Stake Mainnet', () => expect(inspectAddress("stake1u8w9psjnmjk33tx5kwnu7l02fgpdklzjm2z7mfskqzfa88qsjpk8l")).resolves.toEqual({
      "address_style": "Sophie",
      "network_tag": 1,
      "stake_key_hash": "dc50c253dcad18acd4b3a7cf7dea4a02db7c52da85eda6160093d39c",
      "stake_key_hash_bech32": "stake_vkh1m3gvy57u45v2e49n5l8hm6j2qtdhc5k6shk6v9sqj0feccj4rjm",
    ...
    it('Sophie Hex', () => expect(inspectAddress("0147d6fa81a0ca0b1433c0ae405ec04b29255c3ef8f6e30790483783843e250d8d60652a6123b9f705a08732399f57b1179f087429aadc85ba")).resolves.toEqual({
      "address_style": "Sophie",
      "network_tag": 1,
