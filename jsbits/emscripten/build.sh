...
# build cryptonite and bcc-crypto C sources with emscripten

# first run symlink the cbits subdirs of the cryptonite and bcc-crypto packages:
#  ln -s ../cryptonite/cbits cryptonite
#  ln -s ../bcc-crypto/cbits bcc-crypto
...
emcc -o crypto-cbits.js -s WASM=0 \
  ...
  -s "EXPORTED_FUNCTIONS=['_malloc', '_free'\
                         ...
                         ,'_bcc_crypto_ed25519_sign_open', '_bcc_crypto_ed25519_sign', '_bcc_crypto_ed25519_publickey'\
                         ,'_bcc_crypto_ed25519_point_add'\
  ...
  -I. -Icryptonite -Icryptonite/decaf/include -Icryptonite/decaf/include/arch_32 -Icryptonite/blake2/ref -Idecaf/p448 -Idecaf/p448/arch_32 -Ibcc-crypto -Ibcc-crypto/ed25519 \
  ./bcc-crypto/encrypted_sign.c \
  ./bcc-crypto/ed25519/ed25519.c \
...
cat crc32.js crypto-cbits.pre.js crypto-cbits.js crypto-cbits.post.js crypto-wrappers.js > bcc-crypto.js
