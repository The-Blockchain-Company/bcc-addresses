...
-- | An 'Address' type representing 'Bcc' addresses. Internals are
...
-- | Encode a Sophie 'Address' to bech32 'Text', using @addr@ or @addr_test@ as
...
-- | Returns the HRP for a sophie address, using the network tag.
...
-- Describe requirements for address discrimination on the Cole era.
