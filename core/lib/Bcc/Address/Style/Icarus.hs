...
module Bcc.Address.Style.Icarus
    ( -- $overview
...
import Bcc.Address.Style.Cole
    ( coleMainnet, coleStaging, coleTestnet )
import Bcc.Mnemonic
...
--
-- - 'Bcc.Address.Derivation.GenMasterKey': for generating Icarus master keys from mnemonic sentences
...
--
-- We call 'Icarus' addresses the new format of Bcc addresses which came
-- after 'Bcc.Address.Style.Cole.Cole'. This is the format initially used in /klarity2/
-- and now also used by /Klarity/.
...
-- | 'NetworkDiscriminant' for Bcc MainNet & 'Icarus'
--
-- @since 2.0.0
icarusMainnet :: NetworkDiscriminant Icarus
icarusMainnet = coleMainnet

-- | 'NetworkDiscriminant' for Bcc Staging & 'Icarus'
--
-- @since 2.0.0
icarusStaging :: NetworkDiscriminant Icarus
icarusStaging = coleStaging

-- | 'NetworkDiscriminant' for Bcc TestNet & 'Icarus'
--
-- @since 2.0.0
icarusTestnet :: NetworkDiscriminant Icarus
icarusTestnet = coleTestnet
...
-- approach (different from the rest of Bcc).
--
