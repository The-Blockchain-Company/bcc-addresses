...
-- Generate an XPrv using the legacy method (Cole).
--
...
--
-- However, historically, addresses in Bcc used to be generated across both
...
class HardDerivation (key :: Depth -> Type -> Type) where
    ...
    -- derivation scheme 2 (see <https://github.com/The-Blockchain-Company/bcc-crypto/ bcc-crypto>
