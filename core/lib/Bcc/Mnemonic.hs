...
--
-- The concatenated result is split into groups of @11@ bits, each encoding a number from 0 to 2047 serving as an index into a [known dictionary](https://github.com/The-Blockchain-Company/bcc-wallet/tree/master/specifications/mnemonic/english.txt).
...
-- This wraps EntropyError of "Bcc.Encoding.BIP39"
...
-- | This wraps errors from "Bcc.Encoding.BIP39"
      ...
      where
        pretty = \case
            ...
            ErrDictionary (ErrInvalidDictionaryWord _) ->
                ...
                \https://github.com/The-Blockchain-Company/bcc-wallet/tree/master/specifications/mnemonic/english.txt"
